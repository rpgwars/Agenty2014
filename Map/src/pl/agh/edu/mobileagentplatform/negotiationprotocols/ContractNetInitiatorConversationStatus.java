...
public enum ContractNetInitiatorConversationStatus {
	...
	GETTING_PARTICIPANTS_STATUS(-1),SENDING_CALLS_FOR_PROPOSAL_STATUS(0),GETTING_PROPOSALS_STATUS(1),ANSWERING_PROPOSALS_STATUS(2),RECEIVING_INFORM_STATUS(3),FINISHED_STATUS(4);
